...
> 最后更新：2026-09-20（stage2b = 71.0%：A 层九项+F1 反 attractor+scope 验证通过，超预期 +9pp）
...
| 能力 | 阶段1 旧库 | 阶段2 新库 | stage2b（A 层后） | 累计 Δ |
|---|---|---|---|
| **总分** | 38.0% | 53.0% | **71.0%** | **+33pp** |
| 单会话助手 | 5.9% | 76.5% | 76.5% | +70.6pp |
| 单会话用户 | 58.3% | 100% | 83.3% | +25pp ⚠️-2题待查 |
| 时间推理 | 19.0% | 38.1% | **61.9%** | +42.9pp |
| 拒答 | 100% | 100% | 100% | 持平 |
| 偏好 | 36.7% | 50.0% | **100%** | +63pp |
| 知识更新 | 64.3% | 50.0% | **78.6%** | +14.3pp（规则3兑现） |
| 多会话 | 32.0% | 16.0% | **52.0%** | +20pp（scope 兑现） |

⚠ 裁判 = deepseek-flash（同源偏差）；100 题单能力 n=4-25，±1-2 题是噪声量级。
