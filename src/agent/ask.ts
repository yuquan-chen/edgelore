...
export function buildAskPrompt(question: string, memories: readonly string[]): string {
  ...
  return [
    ...
    "2. If entries compete (conflict / tentative), the LATEST-dated one reflects the",
    "   user's CURRENT state: report it as the answer and briefly note the outdated",
    "   value was superseded.",
