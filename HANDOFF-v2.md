...
> 最后更新：2026-09-20（stage3 = 81.0%：v3 重摄入（few-shot 抽取+日期换算+相关维度 top-30）+ 读路径全套，累计 +43pp）
...
| 能力 | 阶段1 | stage2 | stage2b/c | stage3（v3 库） | 累计 Δ |
|---|---|---|---|
| **总分** | 38.0% | 53.0% | 71.0% | **81.0%** | **+43pp** |
| 单会话助手 | 5.9% | 76.5% | 82.4% | +76.5pp |
| 单会话用户 | 58.3% | 100% | 100% | +41.7pp ✅已修复 |
| 时间推理 | 19.0% | 38.1% | 61.9% | **76.2%** | +57.2pp |
| 拒答 | 100% | 100% | 100% | 85.7% | ⚠️-1题待查 |
| 偏好 | 36.7% | 50.0% | 50.0% | **75.0%** | +38.3pp |
| 知识更新 | 64.3% | 50.0% | 71.4% | **78.6%** | +14.3pp |
| 多会话 | 32.0% | 16.0% | 52.0% | **76.0%** | +44pp（抽取保全+日期兑现） |
